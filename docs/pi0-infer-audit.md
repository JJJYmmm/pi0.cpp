...
- `vlacpp-openpi-graph-default-metadata-convert` and
  ...
  OpenPI graph-shaped checkpoint defaults pi0 `action_horizon` to 50 when no
  config metadata is present.
